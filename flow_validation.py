...
excluded_files = [
    config['x_train_filepath'],
    config['y_train_filepath'],
    config['x_test_filepath'],
    config['y_test_filepath']
]
...
commands = [
    f"python random_inference.py {config['x_test_filepath']} {config['y_rand_pred_filepath']}",
    f"python score.py {config['y_test_filepath']} {config['y_rand_pred_filepath']} {config['random_score_filepath']}",
    f"python train.py {config['x_train_filepath']} {config['y_train_filepath']} {config['model_filepath']}",
    f"python model_inference.py {config['model_filepath']} {config['x_test_filepath']} {config['y_pred_filepath']}",
